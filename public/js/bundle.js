...
/***/ function(module, exports, __webpack_require__) {
	...
	{
		var form = React.createFactory(__webpack_require__(159));
	...
	{
		var sign_up = React.createFactory(__webpack_require__(160));
...
/***/ function(module, exports, __webpack_require__) {
	...
	{displayName: "Email",
		getInitialState: function() {
	    		this.setState.email = 'zzz';
			return {'ttt':'hhh'};
	  	},
		componentDidMount:function()
	        {
			 //$("#email").val("tsh@terencehegarty.com");
		},	
	        input: function(e) 
	        {
	        	e.preventDefault();
	        ...
	        {
			return (
	                React.createElement("div", {className: "form_element", id: "react-main-mount"}, 
	                        React.createElement("label", null, "Email"), 
	                        React.createElement("input", {placeholder: "", id: "email", ref: "email", value: this.state.email, onChange: this.input})
	                )
			);
		}
	});
	...
	var SubDomain = React.createClass(
	{
	        ...
	        render: function ()
	        {
	                ...
	                <div className ="form_element">
	                        ...
	                        <input id="subdomain" placeholder="" ref="subdomain" onChange={this.input} />
	                </div>
	                );
	        }
	});
	...
	var MOTD = React.createClass(
	{
		...
		help:function()
		{
			return "This is the message that is displayed in the server list of the client, below the name.";
		},
	        input: function(e)
	        {
	        	e.preventDefault();
		...
		help:function()
		{
	        ...
	        render: function()
	        {
	                ...
	                <div className ="form_element">
	                        ...
	                        <input id="pvp" placeholder="" ref="pvp" onChange={this.input} />
	                </div>
	                );
	        }
	});
	...
	var Difficulty = React.createClass(
	{
		help: function()
		{
			return "Defines the difficulty (such as damage dealt by mobs and the way hunger and poison affects players) of the server.0 - Peaceful 1 - Easy 2 - Normal 3 - Hard";
		},
	        input: function(e)
	        {       
	        	e.preventDefault();
	        ...
	        {       
	                ...
	                <div className ="form_element">
	                        ...
	                        <input id="difficulty" placeholder="" ref="difficulty" onChange={this.input} />
	                </div>
	                );
	        }
	});
	...
	var SeedID = React.createClass(
	{
		help:function()
		{
			return "Add a seed for your world, as in Singleplayer.Some examples are: minecraft, 404, 1a2b3c.";               
		},
		input: function(e) 
		{
			e.preventDefault();
		...
		render: function ()
	        {
	                ...
	                <div className ="form_element">
	                        <label>Seed ID</label>
	                        <input id="seed_id" placeholder="" ref="seed_id" id="seed_id" onChange={this.input}/>
	                </div>
	                );
	        }
	})
	*/ 
	...
	{displayName: "form",
		...
		componentDidMount:function()
		{
			...
			$("#email").val("tsh@terencehegarty.com");
			$("#subdomain").val("devan");
			$("#motd").val("Welcome to my server");
			$("#pvp").val("true");
			$("#difficulty").val("2");
			$("#level_name").val("The Big Multi");
			$("#seed_id").val("12345");
			this.model.email =  $("#email").val();;
			this.model.subdomain = $("#subdomain").val();
			this.model.motd = $("#motd").val();
			this.model.pvp = $("#pvp").val();
			this.model.difficulty = $("#difficulty").val();
			this.model.level_name = $("#level_name").val();
			this.model.seed_id = $("#seed_id").val();
		...
		*/
		...
		submit: function(e)
		{
	        ...
	        {
	                return (
	                React.createElement("div", {id: "react-main-mount"}, 
	  ...
	  render:function() {
	    return (
	      React.createElement("div", {id: "react-main-mount", className: "search-component"}, 
...
/***/ function(module, exports, __webpack_require__) {
	...
	{displayName: "First_name",
	        ...
	        {
	                return (
	                React.createElement("div", {className: "form_element"}, 
	...
	{displayName: "signup_form",
		componentDidMount:function()
		{
			$("#first_name").val("Terence");
			$("#last_name").val("Hegarty");
			$("#email").val("tsh@terencehegarty.com");
			$("#password").val("sheba1810");

			this.model.first_name 	= $("#first_name").val();
			this.model.last_name 	= $("#last_name").val();
			this.model.email 	= $("#email").val();
		...
		submit: function(e)
		{
	        ...
	        {
	                return (
	                React.createElement("div", {id: "signup_form"}, 
				...
				React.createElement(Email2, {model: this.model}), 
				React.createElement("button", {type: "button", className: "btn", onClick: this.submit}, "Submit")
			)
	                );
	        }
	});
